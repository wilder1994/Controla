...
{
    /**
     * @param  array{installation_id: int, kind: string, body: string, is_anonymous: bool, reporter_name?: ?string, reporter_phone?: ?string, photo?: ?UploadedFile}  $data
     */
    public function execute(Client $client, array $data, ?string $ip = null): ObservatoryReport
    {
        ...
        return DB::transaction(function () use ($client, $installation, $kind, $body, $anonymous, $data, $photoPath, $ip): ObservatoryReport {
