...
| 2026-09-17 | Portería: consola vigilante (ingreso unificado, censo, pánico `operational_alerts`). Puerta solo al login del vigilante; Operar portería no. Empleado = empresa; persona = instalación. |
