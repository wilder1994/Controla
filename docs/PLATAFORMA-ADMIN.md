...
**Cartera de clientes** (no conjuntos): mismo alto que Paquete y ciclo; la lista hace scroll interno. En móvil, tope de altura para no empujar el formulario. No pagina.
