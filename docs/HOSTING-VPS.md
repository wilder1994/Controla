...
Parafiscales planilla (14 sep 2026): carpeta en expediente + carga masiva xlsx en `/company/documents`. Sin migrate ni seeder. Pull + `npm run build` + `view:cache` + `route:cache`.
