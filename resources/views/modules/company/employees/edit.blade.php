<x-company-layout :title="'Editar: '.$employee->fullName()">
    ...
    <div class="max-w-4xl space-y-4">
        <form method="POST" action="{{ route('company.employees.update', $employee) }}" enctype="multipart/form-data" class="space-y-4 rounded-lg border border-slate-800 bg-slate-900/80 p-4">
            @csrf
            @method('PUT')
