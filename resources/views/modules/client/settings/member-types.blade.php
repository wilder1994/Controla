    ...
    <div class="grid lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 rounded-xl border border-slate-800 bg-slate-900 overflow-hidden">
            <div class="px-4 py-3 border-b border-slate-800">
                ...
                <p class="text-xs text-slate-500 mt-1">Catálogo de este cliente. Se eligen al registrar una persona en el censo.</p>
            </div>
                    ...
                    <div x-data="{ editing: false }" class="px-4 py-3">
                        ...
                        <form x-show="editing" x-cloak method="POST" action="{{ route('client.settings.member-types.update', $type) }}" class="space-y-3">
                            ...
                            <div class="flex gap-2">
                                <button type="submit" class="rounded-lg bg-teal-600 px-3 py-2 text-xs font-semibold text-white hover:bg-teal-500">Guardar</button>
