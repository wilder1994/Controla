...
Caché SW: `controla-sup-v44`. Hard-refresh tras cambios. Cola ajena se sube en segundo plano y no bloquea al de turno. Login y cambio de clave: icono de ojo para ver la contraseña. APK v1.3: GPS con pantalla apagada (notificación de turno) y pánico.
