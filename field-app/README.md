...
Caché SW: `controla-sup-v38`. Hard-refresh tras cambios. Cola ajena se sube en segundo plano y no bloquea al de turno. Login y cambio de clave: icono de ojo para ver la contraseña.
